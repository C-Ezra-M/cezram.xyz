...
|Pokémon|Icon|Etymology|Notes|
|-|-|-|-|
|#0023 Zołop (Ekans)              |{% pkmnIcon   23 %}|From *połozowate* ([*Colubridae*](https://en.wikipedia.org/wiki/Colubridae)) backwards||
|#0024 Arbok                      |{% pkmnIcon   24 %}|From *kobra* (cobra) backwards; same as English/Japanese||
|#0025 Pikachu                    |{% pkmnIcon   25 %}|Same as English/Japanese||
|#0026 Raichu                     |{% pkmnIcon   26 %}|Same as English/Japanese||
|#0029 Nidoran♀                   |{% pkmnIcon   29 %}|Same as English/Japanese|Read: "Nidoran samica"|
|#0030 Nidorina                   |{% pkmnIcon   30 %}|Same as English/Japanese||
|#0031 Nidoqueen                  |{% pkmnIcon   31 %}|Same as English/Japanese||
|#0032 Nidoran♂                   |{% pkmnIcon   32 %}|Same as English/Japanese|Read: "Nidoran samiec"|
|#0033 Nidorino                   |{% pkmnIcon   33 %}|Same as English/Japanese||
...
|#0151 Mew                        |{% pkmnIcon  151 %}|Same as English/Japanese||
|#0172 Pichu                      |{% pkmnIcon  172 %}|Same as English/Japanese||
|#0175 Togepi                     |{% pkmnIcon  175 %}|Same as English/Japanese||
|#0176 Togetic                    |{% pkmnIcon  176 %}|Same as English/Japanese||
|#0185 Łżewo (Sudowoodo)          |{% pkmnIcon  185 %}|From *łże* (he/she/it lies/states the untruth) and *drzewo* (tree)|Not coined by me! It comes from Dark Archon's patch.|
|#0201 Icognito (Unown)           |{% pkmnIcon  201 %}|From Latin *incognito* (unknown); same as German||
|#0205 Fortyszka (Forretress)     |{% pkmnIcon  205 %}|From *forteca* (fortress) and *szyszka* (pinecone)||
|#0215 Śniegłas (Sneasel)         |{% pkmnIcon  215 %}|From *śnieg* (snow) and *łasica* (weasel)||
|#0218 Ślimagma (Slugma)          |{% pkmnIcon  218 %}|From *ślinik* (slug) and *magma*||
|#0219 Magcargo                   |{% pkmnIcon  219 %}|Same as English/Japanese||
|#0233 Porygon2                   |{% pkmnIcon  233 %}|Same as English/Japanese|The digit 2 is read *dwa*.|
|#0243 Raikou                     |{% pkmnIcon  243 %}|Same as English/Japanese||
|#0244 Entei                      |{% pkmnIcon  244 %}|Same as English/Japanese||
|#0245 Suicune                    |{% pkmnIcon  245 %}|Same as English/Japanese||
|#0248 Tyranitar                  |{% pkmnIcon  248 %}|Same as English|A lot of Polish Pokémon fans call this one "Tyrek". Yes, much like one of the [Poznań Goats](https://en.wikipedia.org/wiki/Pozna%C5%84_Goats). I think it makes me keep the original name.|
...
|#0359 Absol                      |{% pkmnIcon  359 %}|Same as English/Japanese||
|#0363 Fokula (Spheal)            |{% pkmnIcon  363 %}|From *foka* (seal [pinniped]) and *kula* (ball)||
|#0364 Fokongler (Sealeo)         |{% pkmnIcon  364 %}|From *foka* (seal [pinniped]) and *żongler* (juggler)|Inspired by the French name, "Phogleur".|
|#0365 Morsir (Walrein)           |{% pkmnIcon  365 %}|From *mors* (walrus) and *Sir*||
...
|#0455 Łowimuch (Carnivine)       |{% pkmnIcon  455 %}|From *łowić* (to hunt) and *mucha* (fly [insect])|Inspired by *muchołówka*, the Polish word for the Venus flytrap.|
|#0468 Togekiss                   |{% pkmnIcon  468 %}|Same as English/Japanese||
|#0474 Porygon-Z                  |{% pkmnIcon  474 %}|Same as English/Japanese|The letter Z is read *zet*.|
|#0479 Rotom                      |{% pkmnIcon  479 %}|Same as English/Japanese||
|#0483 Dialga                     |{% pkmnIcon  483 %}|Same as English/Japanese||
|#0484 Palkia                     |{% pkmnIcon  484 %}|Same as English/Japanese||
|#0485 Heatran                    |{% pkmnIcon  485 %}|Same as English/Japanese||
...
|#0609 Żyranduch (Chandelure)     |{% pkmnIcon  609 %}|From *żyrandol* (chandelier) and *duch* (ghost)||
|#0625 Katoniec (Bisharp)         |{% pkmnIcon  625 %}|From *kat* (executioner), Japanese 刀 *katana* (sword), *goniec* (bishop [chess piece]), and *koniec* (end [n.])||
...
|#0895 Regidrago                  |{% pkmnIcon  895 %}|Same as English/Japanese||
|#0924 Myszpół (Tandemaus)        |{% pkmnIcon  924 %}|From *mysz* (mouse), *zespół* (team), and *pół* (half)|*pół* is supported by Tandemaus' Violet Pokédex entry: "[...] They split any food they find exactly in half and then eat it together." It also implies that it's a "half" of Maushold.|
|#0925 Rodzimyszy (Maushold)      |{% pkmnIcon  925 %}|From *rodzina* (family), *rodzić* (to give birth), and *myszy* (mice)||
|#0931 Arokadu (Squawkabilly)     |{% pkmnIcon  931 %}|From *arogancki* (arrogant) and *kakadu* (cockatoo)||
|#0973 Flamigo                    |{% pkmnIcon  973 %}|Same as English|No need to change anything. Flamigo's English name is perfect.|
